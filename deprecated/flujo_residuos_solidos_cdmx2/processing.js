...
function side_bar() {
  ...
  fill(0);
  text(
    "El flujo presenta la gestión que\n" +
      ...
      "Actualización: 1/06/2018",
    1280 * 2 + 450,
    100,
  );
  textAlign(LEFT);
  text(
    "Si te interesa colaborar mándame " +
      ...
      "http://www.cdmx.gob.mx/storage/app/media/Guia_Estilos_Sitios_Web_CDMX_v.1.3.pdf",
    100,
    1600,
  );
}
