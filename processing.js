...
function draw(){
    ...
    // Transferencias
    x1_transferencias = 600, y1_transferencias = 30, x2_transferencias = 600, y2_transferencias = 800*2;
    // line(x1_transferencias, 0, x2_transferencias, y2_transferencias);
    // Compactadora, composta y disposición final   
    x1_compactadora = 1280*2-180, y1_compactadora = 180, x2_compactadora = 1280*2-180, y2_compactadora = 800*2;
    x1_composta = x1_compactadora, y1_composta = 50, x2_composta = x1_compactadora, y2_composta = 800*2;
    x1_disposicion = x1_compactadora, y1_disposicion = 265, x2_disposicion = x1_compactadora, y2_disposicion = 800*2;
    x1_recuperacion = x1_compactadora, y1_recuperacion = 850, x2_recuperacion = x1_compactadora, y2_recuperacion = 800*2;
    // line(x1_compactadora, 0, x2_compactadora, y2_compactadora);
    // Selección
    x1_seleccion = 1600, y1_seleccion = 900, x2_seleccion = 1600, y2_seleccion = 800*2;
    x1_rme = x1_seleccion, y1_rme = 870, x2_rme = x1_seleccion, y2_rme = 800*2;
    ...
    x1_particular = 310, y1_particular = 1000, x2_particular = 310, y2_particular = 800*2;
    ...
    strokeWeight(19); stroke(237,65,151,153);
    ...
    strokeWeight(29); stroke(182,117,144,153); 
    ...
    strokeWeight(6); stroke(237,65,151,153);
    ...
    strokeWeight(1); stroke(182,117,144,153); 
    ...
    strokeWeight(3); stroke(237,65,151,153);
    ...
    strokeWeight(8); stroke(237,65,151,153);
    ...
    strokeWeight(35); stroke(237,65,151,153);
    ...
    strokeWeight(2); stroke(182,117,144,153); 
    ...
    strokeWeight(7); stroke(182,117,144,153); 
    ...
    strokeWeight(41); stroke(237,65,151,153);
    ...
    strokeWeight(8); stroke(182,117,144,153); 
    ...
    strokeWeight(15); stroke(237,65,151,153);
    ...
    strokeWeight(9); stroke(182,117,144,153); 
    ...
    strokeWeight(27); stroke(237,65,151,153);
    ...
    strokeWeight(16); stroke(182,117,144,153);
    ...
    } else if(mouseX>x1_compactadora-1431 && mouseX<x1_compactadora-1420 && mouseY>73 && mouseY<104){
        strokeWeight(3); stroke(0);
    ...
    } else if(mouseX>x1_disposicion-1431 && mouseX<x1_disposicion-1420 && mouseY>107 && mouseY<174){
        strokeWeight(3); stroke(0);
    ...
    } else if(mouseX>x1_disposicion-1431 && mouseX<x1_disposicion-1420 && mouseY>179 && mouseY<269){
        strokeWeight(3); stroke(0);
    ...
    } else if(mouseX>x1_disposicion-1431 && mouseX<x1_disposicion-1420 && mouseY>272 && mouseY<303){
        strokeWeight(3); stroke(0);
    ...
    } else if(mouseX>x1_disposicion-1431 && mouseX<x1_disposicion-1420 && mouseY>305 && mouseY<314){
        strokeWeight(3); stroke(0);
    ...
    } else if(mouseX>x1_disposicion-1431 && mouseX<x1_disposicion-1420 && mouseY>319 && mouseY<324){
        strokeWeight(3); stroke(0);
    ...
    } else if(mouseX>x1_recuperacion-1431 && mouseX<x1_recuperacion-1420 && mouseY>340 && mouseY<348){
        strokeWeight(3); stroke(0);
    ...
    if(mouseX>x1_rme-965 && mouseX<x1_rme-955 && mouseY>349 && mouseY<354){
        ...
        fill(0); 
        text("Recolección\n RME",x1_rme+200, 775);
    } else if(mouseX>x1_seleccion-965 && mouseX<x1_seleccion-955 && mouseY>360 && mouseY<439){
        strokeWeight(3); stroke(0);
    ...
    } else if(mouseX>x1_seleccion-965 && mouseX<x1_seleccion-955 && mouseY>445 && mouseY<478){
        strokeWeight(3); stroke(0);
    ...
    } else if(mouseX>x1_transferencias-479 && mouseX<x1_transferencias-469 && mouseY>401 && mouseY<411){
        strokeWeight(3); stroke(0);
    ...
    } else if(mouseX>x1_transferencias-503 && mouseX<x1_transferencias-493 && mouseY>380 && mouseY<390){
        strokeWeight(3); stroke(0);
